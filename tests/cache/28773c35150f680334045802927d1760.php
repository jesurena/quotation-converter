    ...
    <table class="w-full" style="border: 1.5px solid #000; border-collapse: collapse; table-layout: fixed;">
        ...
        <?php $__currentLoopData = $quotation->lineItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php $__currentLoopData = $descLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lineIndex => $descLine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <tr>
                    <td class="px-1 text-center align-top text-sm" style="border-right: 1.5px solid #000; padding-top: <?php echo e($pt); ?>; padding-bottom: <?php echo e($pb); ?>;">
                        <?php if($lineIndex === 0): ?>
                            <?php echo e(number_format($item->quantity)); ?>

                        <?php endif; ?>
                    </td>
                    <td class="px-1 align-top text-sm" style="border-right: 1.5px solid #000; padding-top: <?php echo e($pt); ?>; padding-bottom: <?php echo e($pb); ?>;">
                        <div class="item-description"><?php echo $trimmedLine === '' ? '&nbsp;' : nl2br(e($descLine)); ?></div>
                    </td>
                    <td class="px-1 text-right align-top text-sm" style="border-right: 1.5px solid #000; padding-top: <?php echo e($pt); ?>; padding-bottom: <?php echo e($pb); ?>;">
                        <?php if($lineIndex === 0 && $item->showItemPrices): ?>
                            <?php echo e(number_format($item->unitPrice, 2)); ?>

                        <?php endif; ?>
                    </td>
                    <td class="px-1 text-right align-top text-sm" style="padding-top: <?php echo e($pt); ?>; padding-bottom: <?php echo e($pb); ?>;">
                        <?php if($lineIndex === 0 && $item->showItemPrices): ?>
            ...
            <tr>
                ...
                <td class="p-2 align-top text-xs" style="border-top: 1.5px solid #000; border-right: 1.5px solid #000; padding: 8px;">
                    <?php if($quotation->showWarranty && $quotation->warranty): ?>
                        <div class="mb-1">
                            <div class="font-bold">Warranty:</div> <?php echo nl2br(e($quotation->warranty)); ?>
                    ...
                    <?php if($quotation->showAvailability && $quotation->availability): ?>
                        <div class="mb-1">
                            <div class="font-bold">Availability:</div> <?php echo nl2br(e($quotation->availability)); ?>
                    ...
                    <?php if($quotation->showSpecialNotes && $quotation->notes): ?>
                        <div class="mb-1">
                           <div class="font-bold">Additional Terms:</div> <?php echo nl2br(e($quotation->notes)); ?>
                    ...
                    <?php if($quotation->showValidTill && $quotation->validUntil): ?>
                        <div class="mb-1">
                            <div class="font-bold">Price Valid Until:</div> <?php echo e($quotation->validUntil); ?>
                    ...
                    <?php if($quotation->showTermsOfPayment && $quotation->termsOfPayment): ?>
                        <div class="mb-1">
                            <div class="font-bold">Terms of Payment:</div> <?php echo nl2br(e($quotation->termsOfPayment)); ?>
...
<?php /**PATH C:\Projects\quotation-converter/resources/views/pdf.blade.php ENDPATH**/ ?>