<div style="z-index: 1000; padding-top: 0; background-color: white; position: fixed;">
    <div class="text-center mb-8">
        <b class="uppercase text-4xl">TERMS AND CONDITIONS</b>
    </div>

    <table class="w-full border-collapse" style="table-layout: fixed; border-spacing: 16px 0;">
        <tr>
            
            <td class="align-top text-justify" style="width:50%; padding-right:16px; line-height:1.5; vertical-align:top; letter-spacing:0.4px;">
                ...
                <p><strong class="font-bold">PRICE SPECIFICATION</strong></p>
                ...
                <p><strong class="font-bold">PAYMENT DELIVERY</strong></p>
                ...
                <p><strong class="font-bold">WARRANTY</strong></p>
            ...
            <td class="align-top text-11px text-justify" style="width:50%; padding-left:16px; line-height:1.5; vertical-align:top; letter-spacing:0.4px;">
                <p>
                ...
                <p><strong class="font-bold">PROGRAM PRODUCT LICENSES</strong></p>
                ...
                <p><strong class="font-bold">DEFAULT</strong></p>
                ...
                <p><strong class="font-bold">MISCELLANEOUS</strong></p>
